...
def percent_by_education(counties:list, education_level:str):
    ...
    for i in range(len(counties)):
        education_population = education_population + education_population_list[i]
    population_list = [i.population for i in counties]
    total_population = 0
    for i in range(len(counties)):
...
def percent_by_ethnicity(counties:list, ethnicity:str):
    ...
    for i in range(len(counties)):
        ethnicity_population = ethnicity_population + ethnicity_population_list[i]
    population_list = [i.population for i in counties]
    total_population = 0
    for i in range(len(counties)):
        total_population = total_population + counties[i].population['2014 Population']
...
def percent_below_poverty_level(counties:list):
    ...
    for i in range(len(counties)):
        poverty_population = poverty_population + poverty_list[i]
    population_list = [i.population for i in counties]
    total_population = 0
    for i in range(len(counties)):
        total_population = total_population + counties[i].population['2014 Population']
